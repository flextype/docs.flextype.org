...
```php
flextype('media')
            ->files()->move('entries/movies/sg-1/season-5/episode-21/cover.jpg',
...
```php
flextype('media')
            ->files()->copy('entries/movies/sg-1/season-5/episode-21/cover.jpg',
...
$folders = flextype('media')
                ->folders()
                ->fetch('entries/movies/sg-1/season-5');
```
